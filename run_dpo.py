...
from data_collator_dpo import create_data_loader
from trainer_dpo import SVCOTrainerForLlava
...
def train():
    ...
    if training_args.svco:
        train_dataset, data_collator = create_data_loader(model_type=model_args.model_family_id,
        ...
        eval_dataset, data_collator = create_data_loader(model_type=model_args.model_family_id,
