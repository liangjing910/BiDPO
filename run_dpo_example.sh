...
RUN_NAME=llava7b  # experiment name --> used for logging & checkppint-saving directory

MODEL_FAMILY_ID=llava-1.5  # choose from: ["llava-interleave", "llava-1.5"]
MODEL_NAME_OR_PATH="./checkpoints/llava-1.5-7b-hf"  # choose from: ["llava-hf/llava-interleave-qwen-7b-hf", "llava-hf/llava-1.5-7b-hf"] or any other size
...
DS_STAGE=zero2  # deepspeed stage "zero3"
...
torchrun $DISTRIBUTED_ARGS run_dpo.py \
    --svco $SVCO \
    --run_name $RUN_NAME \
